/*
 * ARMCC startup file for ATSAMC21N17A
 *
...
// Check if DeviceVectors is defined and create a typedef to VECTOR_TABLE_Type
    ...
    typedef DeviceVectors VECTOR_TABLE_Type; // Defines the toolchain agnostic type of the vector table type defined in the 'samc21n17a.h'
